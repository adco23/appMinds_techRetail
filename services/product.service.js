...
const createProduct = (data) => {
  ...
  const existingId = products.find(
  ...
  const storeExists = stores.find(
    (store) => store.id === parseInt(data.storeId)
  );
...
const updateProduct = (id, data) => {
  ...
  product.price =
    data.price !== undefined ? Number(data.price) : product.price;
  product.stock =
    data.stock !== undefined ? Number(data.stock) : product.stock;
